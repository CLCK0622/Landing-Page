...
import {profileData, linksData, designColors} from '@/data/links-data';
        ...
        <main className={styles.main}>
            ...
            <header className={styles.header}>
                ...
                <aside className={styles.sidebar}>
                    <ProfileCard data={{ ...profileData, bio: t('bio') }} />
                </aside>
                    ...
                    <div className={styles.linksGrid}>
                        {linksData.map((link) => (
                            <LinkCard
                                ...
                                link={{
                                    ...link,
                                    titleKey: t(link.titleKey),
                                    descriptionKey: t(link.descriptionKey),
                                }}
                            />
                        ))}
                    </div>
